...
#
# Specify output file.
#SBATCH --output=test_multi_gpu_%j.log
#
# Specify error file.
#SBATCH --error=test_multi_gpu_%j.err
#
...
torchrun --nproc_per_node=$NUM_GPUS distill.py machine=cluster train_params.run_name=test_multi_gpu_cluster
