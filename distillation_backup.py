...
def get_args_parser():
    ...
    # Data
    parser.add_argument("--dataset", type=str, default="thank_you", choices=["coco2017", "ETH3D", "ETH3D_single", "thank_you"], help="Seleziona il dataset")
    ...
    parser.add_argument("--resume_encoder_ckpt", type=str, default="/cluster/work/igp_psr/niacobone/distillation/output/SV_03_new/checkpoints/checkpoint_best.pth", help="Path to encoder checkpoint to load")
