...
from sam2_minimal.modeling.sam2_base import NO_OBJ_SCORE, SAM2Base
from sam2_minimal.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def from_pretrained(cls, model_id: str, **kwargs) -> "SAM2VideoPredictor":
        ...
        """
        from sam2_minimal.build_sam import build_sam2_video_predictor_hf
